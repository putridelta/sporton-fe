    ...
    <CardWithHeader title="Order Information">
      <div className="p-5">
        <div className="input-group">
          ...
          <input type="text" className="w-full px-4 py-2 border bg-gray-200 border-gray-200 rounded-lg mb-4 mt-1" placeholder="Type your full name" id="customerName" name="customerName" value={formData.customerName} onChange={handleInputChange} />
        </div>
        <div className="input-group">
