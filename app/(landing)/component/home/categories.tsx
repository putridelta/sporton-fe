        ...
        <section id="category-section" className="container my-[80px] mx-auto px-[20px]">
            ...
            <div className="flex flex-row gap-10 pt-2">
              {categories.map((category)=> (
                ...
                <div key={category._id} className = "bg-gradient-to-r from-[#F1F1F1] to-[#F7F7F7D1] rounded-lg p-[40px] ">
                ...
                fill
                 ...
                 <p className="pt-2 text-center text-xl text-medium text-primary">{category.name}</p>
               </div>
              )) }
